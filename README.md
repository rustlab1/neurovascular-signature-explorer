...
- **Gene search** - per-gene heatmap of log2 fold-change across cell types and the three diseases.
...
| `data.js` | Pre-computed data (`window.NV`), generated by `build_data.py` |
